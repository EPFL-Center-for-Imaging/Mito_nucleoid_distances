...
if __name__ == "__main__":
    ...
    for folder in pathlib.Path("C:/Users/landoni/Desktop/Pearling Desktop/siRNA_GA_crops/Test").glob("*"):
        ...
        label_path = nellie_output_dir / "nellie_necessities" / f"{img_path.stem}-ZCYX-Z0p2_Y0p056_X0p056-ch{ch}-im_skel.ome.tif"
